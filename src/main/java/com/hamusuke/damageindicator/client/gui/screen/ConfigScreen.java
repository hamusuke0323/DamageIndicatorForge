...
public class ConfigScreen extends Screen {
    private static final Component HIDE_INDICATOR = Component.translatable("options.damageindicator.hideIndicator");
    private static final Component FORCE_INDICATOR_RENDERING = Component.translatable("options.damageindicator.forceindicatorrendering");
    private static final Component CHANGE_COLOR_WHEN_CRIT = Component.translatable("options.damageindicator.changeColorWhenCrit");
    ...
    @Override
    protected void init() {
        this.addRenderableWidget(new Button(this.width / 4, this.height / 2 - 60, this.width / 2, 20, CommonComponents.optionStatus(HIDE_INDICATOR, Config.CLIENT.hideIndicator.get()), p_onPress_1_ -> {
        ...
        this.addRenderableWidget(new Button(this.width / 4, this.height / 2 - 40, this.width / 2, 20, CommonComponents.optionStatus(FORCE_INDICATOR_RENDERING, Config.CLIENT.forceIndicatorRendering.get()), p_onPress_1_ -> {
        ...
        this.addRenderableWidget(new AbstractSliderButton(this.width / 4, this.height / 2 - 20, this.width / 2, 20, CommonComponents.optionNameValue(Component.translatable("options.damageindicator.fontsize"), Component.literal(Math.round(Config.CLIENT.fontSize.get() * 100.0D) + "%")), Config.CLIENT.fontSize.get()) {
            @Override
            protected void updateMessage() {
                this.setMessage(CommonComponents.optionNameValue(Component.translatable("options.damageindicator.fontsize"), Component.literal(Math.round(Config.CLIENT.fontSize.get() * 100.0D) + "%")));
            }
        ...
        this.addRenderableWidget(new AbstractSliderButton(this.width / 4, this.height / 2, this.width / 2, 20, Component.translatable("options.damageindicator.displayDistance").append(": ").append("" + Config.CLIENT.renderDistance.get()), (double) Config.CLIENT.renderDistance.get() / 1024.0D) {
            @Override
            protected void updateMessage() {
                this.setMessage(Component.translatable("options.damageindicator.displayDistance").append(": ").append("" + Config.CLIENT.renderDistance.get()));
            }
        ...
        this.addRenderableWidget(new Button(this.width / 4, this.height / 2 + 20, this.width / 2, 20, CommonComponents.optionStatus(CHANGE_COLOR_WHEN_CRIT, Config.CLIENT.changeColorWhenCrit.get()), p_onPress_1_ -> {
        ...
        this.addRenderableWidget(new Button(this.width / 4, this.height / 2 + 40, this.width / 2, 20, Component.translatable(DamageIndicator.MOD_ID + ".config.colorConfig.title"), p_onPress_1_ -> this.minecraft.setScreen(new ColorSettingsScreen(this))));
    ...
    private static class ColorSettingsScreen extends Screen {
        ...
        private ColorSettingsScreen(@Nullable Screen parent) {
            super(Component.translatable(DamageIndicator.MOD_ID + ".config.colorConfig.title"));
            this.parent = parent;
        }
        ...
        private class ColorList extends ObjectSelectionList<ColorList.Color> {
            ...
            private class Color extends ObjectSelectionList.Entry<Color> {
                ...
                private Color(Config.ClientConfig.ColorConfig.RGB rgbConfig) {
                    this.button = new Button(ColorSettingsScreen.this.width / 4, 0, ColorSettingsScreen.this.width / 2, 20, Component.translatable(DamageIndicator.MOD_ID + ".config.color." + rgbConfig.path), p_onPress_1_ -> ColorSettingsScreen.this.minecraft.setScreen(new ColorMixingScreen(ColorSettingsScreen.this, rgbConfig)));
                }
        ...
        private static class ColorMixingScreen extends Screen {
            ...
            private ColorMixingScreen(@Nullable Screen parent, Config.ClientConfig.ColorConfig.RGB rgb) {
                super(Component.translatable(DamageIndicator.MOD_ID + ".config.color." + rgb.path));
                this.parent = parent;
                this.rgb = rgb;
            }
